...
<section class="technology-tabing l_py s_py">
	<div class="container custom-container">
		<div class="row">
			<div class="col-lg-12 headingRow">
				<h2>Explore Our Python Technology Competence</h2>
				<p>Our proficient Python full-stack developers hold in-depth expertise in utilizing the high-level dynamic programming language along with related development tools to build simple-to-complex web apps. Glad if you take a quick tour of our technology competency in this domain</p>
			</div>
			<div class="col-lg-12">
				<!-- Nav tabs -->
